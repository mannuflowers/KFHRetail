...
class statementCollectionViewCell: UICollectionViewCell {
    ...
    override init(frame: CGRect) {
        ...
        imageLabel.anchor(top: contentView.topAnchor, left: nil, bottom: nil, right: contentView.rightAnchor, paddingTop: 10, paddingLeft: 0, paddingBottom: 0, paddingRight: 8, width: 19, height: 24)
